  ...
  return (
    ...
    <div className="bg-white max-w-6xl w-full p-12 border border-gray-100 shadow-sm relative">
      ...
      <div className="flex flex-row items-center justify-between mt-6 mb-16">
        <div className="w-56 h-56 bg-[#d9d9d9] rounded-full flex items-center justify-center text-center p-6 text-[10px] text-black">
      ...
      <div className="w-48 h-48 flex items-center justify-center">
        <img src="/hanni.jpg" alt="Hanni" className="w-full h-auto object-contain"/>
      </div>
      
      {/*Bottom sections*/}
      <div className="flex flex-row gap-8 items-stretch w-full justify-center">
        <div className="flex-1 flex flex-col min-w-[300px]">
          ...
          <div className="bg-[#d3e6ff] border-2 border-black p-3 h-full flex flex-col">
            <div className="bg-white p-4 flex-1">
              <div className="w-full h-24 mb-4 overflow-hidden flex justify-center items-center">
